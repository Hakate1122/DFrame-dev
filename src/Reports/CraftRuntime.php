...
class CraftRuntime
{
    ...
    public static function render($message, $file = null, $line = null, $errno = null)
    {
        ...
        <head>
            ...
            <title>Runtime Error: " . htmlspecialchars($message, ENT_QUOTES) . "</title>
            <style>
                * { margin:0; padding:0; box-sizing:border-box; }
                ...
                .error-header { background: linear-gradient(135deg,#f59e0b,#d97706); color:white; padding:15px 20px; font-weight:500; font-size:14px; display:flex; justify-content:space-between; align-items:center; }
                ...
                .error-title h2 { color:#f59e0b; font-size:18px; font-weight:600; margin-bottom:8px; }
                ...
                .error-line { background:#fef3c7 !important; color:#92400e !important; font-weight:bold; border-left:6px solid #f59e0b; box-shadow:0 0 8px #f59e0b33; }
                .error-line .line-number { background:#fef3c7 !important; color:#92400e !important; border-right:1px solid #f59e0b; }
                .error-line .line-content { background:#fef3c7 !important; color:#92400e !important; }
